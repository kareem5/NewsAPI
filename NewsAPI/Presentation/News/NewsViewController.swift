...
class NewsViewController: UITableViewController, Alertable {
    ...
    init(viewModel: NewsViewModel, coordinator: MainCoordinator) {
        ...
        filterVC = FilterViewController(viewModel: viewModel)
    ...
    private func setupNavigationBarButtons() {
        let filterBarButtonItem = UIBarButtonItem(image: UIImage(named:  Icons.filterIcon.rawValue), style: .plain, target: self, action: #selector(filterIconTapped))
